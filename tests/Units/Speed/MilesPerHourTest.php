 ...
 */
class MilePerHourTest extends AbstractTestCase
{
    /**
     * Unit instance.
     *
    ...
    public function testName(): void
    {
        ...
        $this->assertEquals(expected: 'Mile per hour', actual: $this->unit->getName());
    }
    ...
    public function testAbbreviation(): void
    {
        ...
        $this->assertEquals(expected: 'mph', actual: $this->unit->getAbbreviation());
    }
    ...
    public function testToString(): void
    {
        ...
        $this->assertEquals(expected: 'mph', actual: (string) $this->unit);
    }
}
