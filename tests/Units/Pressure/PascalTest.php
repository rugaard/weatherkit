 ...
 */
class PascalTest extends AbstractTestCase
{
    /**
     * Unit instance.
     *
    ...
    public function testName(): void
    {
        ...
        $this->assertEquals(expected: 'Pascal', actual: $this->unit->getName());
    }
    ...
    public function testAbbreviation(): void
    {
        ...
        $this->assertEquals(expected: 'Pa', actual: $this->unit->getAbbreviation());
    }
    ...
    public function testToString(): void
    {
        ...
        $this->assertEquals(expected: 'Pa', actual: (string) $this->unit);
    }
}
