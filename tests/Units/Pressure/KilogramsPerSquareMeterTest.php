...
/**
 * KilogramForcePerSquareMeterTest.
 *
 * @package Rugaard\WeatherKit\Tests\Units
 */
class KilogramForcePerSquareMeterTest extends AbstractTestCase
{
    /**
     * Unit instance.
     *
    ...
    {
        $this->unit = new KilogramForcePerSquareMeter;
    }
    ...
    public function testName(): void
    {
        ...
        $this->assertEquals(expected: 'Kilogram-force per square meter', actual: $this->unit->getName());
    }
    ...
    public function testAbbreviation(): void
    {
        ...
        $this->assertEquals(expected: 'kgf/m²', actual: $this->unit->getAbbreviation());
    }
    ...
    public function testToString(): void
    {
        ...
        $this->assertEquals(expected: 'kgf/m²', actual: (string) $this->unit);
    }
}
