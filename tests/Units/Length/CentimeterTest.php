...
class CentimeterTest extends AbstractTestCase
{
    ...
    public function testName(): void
    {
        ...
        $this->assertEquals(expected: 'Centimeter', actual: $this->unit->getName());
    }
    ...
    public function testAbbreviation(): void
    {
        ...
        $this->assertEquals(expected: 'cm', actual: $this->unit->getAbbreviation());
    }
    ...
    public function testToString(): void
    {
        ...
        $this->assertEquals(expected: 'cm', actual: (string) $this->unit);
    }
}
