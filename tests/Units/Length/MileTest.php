 ...
 */
class MileTest extends AbstractTestCase
{
    /**
     * Unit instance.
     *
    ...
    public function testName(): void
    {
        ...
        $this->assertEquals(expected: 'Mile', actual: $this->unit->getName());
    }
    ...
    public function testAbbreviation(): void
    {
        ...
        $this->assertEquals(expected: 'mi', actual: $this->unit->getAbbreviation());
    }
    ...
    public function testToString(): void
    {
        ...
        $this->assertEquals(expected: 'mi', actual: (string) $this->unit);
    }
}
