 ...
 */
class KilometerTest extends AbstractTestCase
{
    /**
     * Unit instance.
     *
    ...
    public function testName(): void
    {
        ...
        $this->assertEquals(expected: 'Kilometer', actual: $this->unit->getName());
    }
    ...
    public function testAbbreviation(): void
    {
        ...
        $this->assertEquals(expected: 'km', actual: $this->unit->getAbbreviation());
    }
    ...
    public function testToString(): void
    {
        ...
        $this->assertEquals(expected: 'km', actual: (string) $this->unit);
    }
}
